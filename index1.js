...
//In a main function use the array below to create an array of
//FacebookUser objects and console.log that new array.
...
// NOTE : call a avraible AFTER you define it. 
...
myArray.forEach(myfunction); // its forEach NOT foreach
...
let Fuser = new facebookUser("Marvin");
// console.log(Fuser.facebook_user()); // you called this function but never defined it
